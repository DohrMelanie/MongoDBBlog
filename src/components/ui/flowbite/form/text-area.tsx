export default function Textarea({ name, placeholder, value, onChange }: { name: string, placeholder: string, value?: string, onChange?: (e: React.ChangeEvent<HTMLTextAreaElement>) => void }) {
    return (
        <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div className="flex items-center justify-between px-3 py-2 border-t dark:border-gray-600 border-gray-200">
                <p className="text-sm text-gray-200">Mind that this will be Markdown formatted</p>
