export default function BigBoxSkeleton({ className }: { className?: string }    ) {
    return (
        <div role="status" className={`p-4 border border-gray-200 rounded-sm shadow-sm animate-pulse md:p-6 dark:border-gray-700 ${className}`}>
