...
async function GET(request, { params }) {
    const { id } = params;
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$user$2d$manager$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getUserById(new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](id));
    if (!user) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(publicUser);
}
}}),

};

//# sourceMappingURL=%5Broot%20of%20the%20server%5D__70da87ec._.js.map